        ...
        <div className={styles.performance}>
          ...
          <div className={styles.barTrack}>
            <div
              ...
              style={{ width: `${deck.pct}%`, background: barColor(deck.pct) }}
            />
          </div>
      ...
      {showRegen && (
        <div className={styles.regenPanel}>
          ...
          <div className={styles.regenActions}>
            <button
              className={styles.btnConfirmRegen}
              onClick={() => onRegenerate(deck, difficulty)}
            >
              ✦ Gerar novas perguntas
            </button>
            <button
              className={styles.btnCancelRegen}
      ...
      <div className={styles.body}>
        <div className={styles.header}>
          ...
          <p className={styles.sub}>
            Seus baralhos salvos — estude com as mesmas perguntas ou gere novas
          </p>
        </div>
