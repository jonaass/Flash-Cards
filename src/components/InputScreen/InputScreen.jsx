        ...
        <div className={styles.left}>
          ...
          <div className={styles.field}>
            ...
            <input
              ...
              placeholder="Ex: Biologia — Célula" maxLength={60}
            />
          ...
          {isNearMax && !isOverMax && (
            <p className={styles.warnMsg}> Texto próximo do limite — será truncado automaticamente se ultrapassar.</p>
          )}
          {isOverMax && (
            <p className={styles.dangerMsg}> Texto acima do limite e será cortado automaticamente ao gerar.</p>
          )}
          {length > 0 && !isReady && (
          ...
          <button
            ...
            disabled={!isReady}
            onClick={() => isReady && startGeneration(text.trim(), deckName.trim() || 'Sem título', difficulty)}
          >
            Gerar flashcards
          </button>
        </div>
